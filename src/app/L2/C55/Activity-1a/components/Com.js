...
const questions = [
  {
    ...
    answer: "Each country has its own money because they have different rules, leaders, and ways of running their country. Money shows the identity of a country’s system, so every nation makes its own.",
  ...
  {
    question: "If every country has its own money, how do people pay when they visit another country?",
  ...
  },
  {
    ...
    answer: "To change money from one country to another, we multiply it by the exchange rate. The exchange rate tells us how much that money is worth in our country’s money.",
